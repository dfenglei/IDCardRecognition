package com.nick.idcard.permissions;
...
{
    public static @Nullable AlertDialog explainingDialog(@NonNull final IDRecognitionModule module,
    ...
    public interface OnExplainingPermissionCallback {
        void onCancel(WeakReference<IDRecognitionModule> moduleInstance, DialogInterface dialogInterface);
        void onReTry(WeakReference<IDRecognitionModule> moduleInstance, DialogInterface dialogInterface);
    }
}